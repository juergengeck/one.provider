 ...
 *
 * Any module in any project using one.core directly or indirectly can add their own ONE object
 * and Plan return types by adding to this ambient module name.
 *
